...
<head>
  ...
  <title>Inscivez-vous ! | Potajou</title>
...
H230C221.9,78,215.2,72.8,215.2,64z"
        ...
        <button class="cta">
          <a href="formulaire.php"><span class="hover-underline-animation"> Se connecter ?</span></a>
          <svg
            id="arrow-horizontal"
            xmlns="http://www.w3.org/2000/svg"
            width="30"
...
<rect width="30" height="49" fill="white"/>
    ...
    <?php
        ...
        ?>
    <form class="form" action="../traitement/valid_enregistrer.php" method="POST" enctype="multipart/form-data">
    <label for="photo" class="custom-file-upload"><img src="../images/img-picto.webp" class="p-image" alt=""></label>
    <p class="title-p">Vous pouvez déposer une photo ici</p>
    <input type="file" name="photo" id="photo" class="input-03">
        <label for="mail">Adresse mail:</label>
        <input type="email" id="mail" class="input-03" name="mail" placeholder="E-mail">
        
        <label for="nom">Nom d'utilisateur:</label>
        <input type="text" id="nom" name="nom" class="input-03" placeholder="Nom d'utilisateur">
        
        <label for="mdp">Mot de passe:</label>
        <input type="password" id="mdp" name="mdp" class="input-03" placeholder="Mot de passe">
        
        <label for="mdp2">Confirmez votre mot de passe:</label>
        <input type="password" id="mdp2" name="mdp2" class="input-03" placeholder="Confirmation Mot de passe">
        
        <p class="page-link">
            <a href="formulaire.php"><span class="page-link-label">Déjà membre? Se connecter</span></a>
        </p>
        <button type="submit" class="form-btn-02" class="scroll-to-top">S'inscrire</button>
    </form>
</div>
<footer>
        <div class="footer-p1">
...
<script>
// Simule la fin du chargement après un délai (à remplacer par votre logique de chargement réelle)
setTimeout(function() {
  var loader = document.getElementById('loader');
  loader.style.animation = 'fadeOut 0.3s ease forwards'; // Lance l'animation de fondu
  setTimeout(function() {
    loader.classList.remove('active'); // Cache le loader après l'animation
    loader.style.zIndex = '-1'; // Change le z-index à -1
  }, 500); // Temps d'attente correspondant à la durée de l'animation fadeOut
}, 3000); // Délai de simulation du chargement (à remplacer par votre logique de chargement réelle)
</script>
    </section>
</html>
