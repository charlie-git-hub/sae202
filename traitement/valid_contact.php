...
if ($erreurs > 0) {
    ...
    $_SESSION['information_type'] = 'error';
...
$headers = [
    'From' => "mmi23c11@mmi-troyes.fr",
    'Reply-To' => "mmi23c11@mmi-troyes.fr",
    'X-Mailer' => 'PHP/' . phpversion(),
    'MIME-Version' => '1.0',
